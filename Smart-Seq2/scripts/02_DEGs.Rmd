...
saveRDS(seu.filter, "~/data/data3/jarning/seq-data/z541.ss2/z541_ss2.seu_final.rds")
```
...
saveRDS(dge.counts, "~/data/data3/jarning/seq-data/z541.ss2/pseudo-bulk.counts.rds")
```
