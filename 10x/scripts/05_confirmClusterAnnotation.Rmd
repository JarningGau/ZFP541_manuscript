...
chen2018 <- readRDS("~/data/data3/jarning/public/TestisAtlas/data/cache/CellRes2018_30061742.rds")
...
seu.2$celltype <- chen2018$cell_type[colnames(seu.1), 1]
...
```{r saveData}
out.dir <- "tmp/confirmCellAnnotation/"
dir.create(out.dir)
